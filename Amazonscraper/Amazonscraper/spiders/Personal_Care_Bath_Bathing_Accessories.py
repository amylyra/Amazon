...
class PersonalCareBathBathingAccessoriesSpider(scrapy.Spider):
    name = "Personal_Care_Bath_Bathing_Accessories"
    ...
    def start_requests(self):
        ...
        start_urls = [
            'https://www.amazon.com/s/ref=lp_11055991_nr_p_8_0?fst=as%3Aoff&rh=n%3A3760911%2Cn%3A%2111055981%2Cn%3A3777891%2Cn%3A11055991%2Cp_8%3A2229013011&bbn=11055991&ie=UTF8&qid=1502519088&rnid=598261011',
            'https://www.amazon.com/s/ref=lp_11055991_nr_p_8_1?fst=as%3Aoff&rh=n%3A3760911%2Cn%3A%2111055981%2Cn%3A3777891%2Cn%3A11055991%2Cp_8%3A2229014011&bbn=11055991&ie=UTF8&qid=1502519088&rnid=598261011',
            'https://www.amazon.com/s/ref=lp_11055991_nr_p_8_2?fst=as%3Aoff&rh=n%3A3760911%2Cn%3A%2111055981%2Cn%3A3777891%2Cn%3A11055991%2Cp_8%3A2229015011&bbn=11055991&ie=UTF8&qid=1502519088&rnid=598261011',
            'https://www.amazon.com/s/ref=lp_11055991_nr_p_8_3?fst=as%3Aoff&rh=n%3A3760911%2Cn%3A%2111055981%2Cn%3A3777891%2Cn%3A11055991%2Cp_8%3A598265011&bbn=11055991&ie=UTF8&qid=1502519088&rnid=598261011',
        ]
    ...
    def getDetail(self, response):
        ...
        if asin:
            ...
            # catetxt = response.xpath('//ul[@class="zg_hrsr"]/li[1]/span[@class="zg_hrsr_ladder"]//text()').extract()
            # print catetxt
            # print re.sub("\s", " ", ''.join(catetxt)).strip()
            # print re.sub(" +", " ", re.sub("\s", " ", ''.join(catetxt)).strip())
            # return
            # try:
            #     del catetxt[0]
            # except:
            #     catetxt = "Beauty & Personal Care : Skin Care : Face : Cleansers : Bars"
            ...
            price = ''.join(response.xpath('//span[contains(@id, "priceblock_")]/text()').extract()).strip()
            item['Price'] = price
            # print price
