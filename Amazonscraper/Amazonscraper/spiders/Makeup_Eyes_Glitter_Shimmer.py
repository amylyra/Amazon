...
class MakeupEyesGlitterShimmerSpider(scrapy.Spider):
    name = "Makeup_Eyes_Glitter_Shimmer"
    ...
    def start_requests(self):
        print "====== Start ======"  
        url = "https://www.amazon.com/s/ref=sr_nr_n_5?fst=as%3Aoff&rh=n%3A3760911%2Cn%3A%2111055981%2Cn%3A11058281%2Cn%3A11058331%2Cn%3A3006286011&bbn=11058331&ie=UTF8&qid=1502797085&rnid=11058331"
    ...
    def getData(self, response):
        ...
        try:
            ...
            # urls = [
            # "https://www.amazon.com/Eleacc-Temperature-Changing-Gelpolish-7-3milliliter/dp/B017LYVYCK/ref=lp_3782871_1_41_s_it/131-1147720-3190652?s=beauty&ie=UTF8&qid=1503108471&sr=1-41",
            # "https://www.amazon.com/Barielle-Protein-Base-Solution-Ounce/dp/B01BFGZ2SW/ref=sr_1_156_s_it?s=beauty&ie=UTF8&qid=1503109796&sr=1-156",
            # "https://www.amazon.com/Barielle-Quick-Coat-Solution-Ounce/dp/B000PO59FW/ref=sr_1_157_s_it?s=beauty&ie=UTF8&qid=1503109796&sr=1-157",
            # ]
